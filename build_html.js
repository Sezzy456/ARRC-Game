...
<body>
    ...
    class MainScene extends Phaser.Scene {
        ...
        triggerBusRushEvent() {
            ...
            busGfx.fillRoundedRect(0, 0, 126, 44, 8);
            busGfx.lineStyle(3, 0xffeb3b, 1);
            busGfx.strokeRoundedRect(0, 0, 126, 44, 8);

            // Windows
            busGfx.fillStyle(0x81d4fa, 1);
            busGfx.fillRoundedRect(10, 8, 22, 14, 3);
            busGfx.fillRoundedRect(36, 8, 22, 14, 3);
            busGfx.fillRoundedRect(62, 8, 22, 14, 3);
            busGfx.fillRoundedRect(88, 8, 26, 14, 3);

            // Wheels
            busGfx.fillStyle(0x212121, 1);
            busGfx.fillCircle(24, 44, 7);
            busGfx.fillCircle(102, 44, 7);

            const labelText = this.add.text(63, 31, '🚌 +10 (TAP/B)', {
                fontSize: '11px', style: 'bold', color: '#ffffff'
            }).setOrigin(0.5);

            busContainer.add([busGfx, labelText]);

            // Generous touch hit area (190px wide x 110px tall) so it's super easy to tap on mobile and PC!
            const hitArea = new Phaser.Geom.Rectangle(-32, -30, 190, 110);
            busContainer.setSize(190, 110);
